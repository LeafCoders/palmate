...
<channel>
	...
	<wp:author><wp:author_id>1</wp:author_id><wp:author_login>admin</wp:author_login><wp:author_email>admin@admin.se</wp:author_email><wp:author_display_name><![CDATA[admin]]></wp:author_display_name><wp:author_first_name><![CDATA[]]></wp:author_first_name><wp:author_last_name><![CDATA[]]></wp:author_last_name></wp:author>
...
File.open('wordpress-content.xml', 'w') do |out|
  ...
  container = Container.new(). \
    ...
    add(HomePage.new()). \
    # Page1
    add(Page.new("page1", "Page 1", "page-groups.php") \
      .add(Page.new("page1a", "Part A", "page-group.php")) \
      .add(Page.new("page1b", "Part B", "page-group.php")) \
    ). \
    # Page2
    add(Page.new("page2", "Page 2", "page-groups.php") \
      .add(Page.new("page2a", "Part A", "page-group.php")) \
    ). \

    # Menu for desktops
    add(MenuTop.new($menu_desktop, "page1", "Page 1", "/page1")). \
    add(MenuTop.new($menu_desktop, "page1a", "Part 1A", "/page1/#part1a")). \
    add(MenuTop.new($menu_desktop, "page1b", "Part 1B", "/page1/#part1b")). \

    # Menu for mobile devices
    add(MenuTop.new($menu_desktop, "page1", "Page 1", "/page1")). \
    add(MenuTop.new($menu_desktop, "page2", "Page 2", "/page2"))
