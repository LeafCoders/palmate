...
<head>
  ...
  <link rel="apple-touch-startup-image" sizes="640x920" media="(device-width: 320px) and (-webkit-device-pixel-ratio: 2)" href="<?php echo get_template_directory_uri(); ?>/assets/img/touch-startup-retina.png">
